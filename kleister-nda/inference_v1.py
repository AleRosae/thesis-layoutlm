...
model = torch.load('models/LayoutLMv1_kleister-nda.pt', map_location=device)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='''inference with LayoutLMv1 finetuned on Kleister-nda''')
