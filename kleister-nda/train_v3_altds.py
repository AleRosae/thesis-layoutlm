...
train = create_DS('data_seglevel/training_data')
test = create_DS('data_seglevel/testing_data')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default = 5e-5, help='Learning rate for training. Default is 2e-5')
    parser.add_argument('--epochs', type=int, default=10, help='Number of epochs. Default is 25')
    parser.add_argument('--patience', type=int, default=7, help='Patience. Default is 15')
    ...
    torch.save(model, 'models/LayoutLMv3_seglevel_kleister-nda.pt')
