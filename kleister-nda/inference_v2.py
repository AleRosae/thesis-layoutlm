...
from transformers import LayoutLMv2Processor, logging, LayoutLMv2ForTokenClassification
...
model = torch.load('models/LayoutLMv2_kleister-nda.pt', map_location=device)
model.to(device)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='''inference with LayoutLMv2 finetuned on Kleister-NDA''')
